...
<head>
	...
	<body>
						...
						<div class="item">
							<div class="doctor-profile-widget doc-item">
								...
								<div class="doc-content">
									<div class="doc-pro-info">
										<div class="doc-pro-name">
											<a href="doctor-profile.html">Dr. Palmore</a>
											<p>Immunologist</p>
										</div>
										<div class="reviews-ratings">
											<p>
								...
								<div class="card-body">
									...
									<div class="pricing-info">
										...
										<div class="pricing-btn">
											<a href="login.jsp" class="btn">Choose Plan</a>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="articles-info">
									...
									<div class="articles-right">
										<div class="articles-content">
											...
											<h4>
												<a href="">Navigating Telehealth: A Guide to Virtual Healthcare Visits</a>
											</h4>
							...
							<div class="articles-grid w-100">
								<div class="articles-info">
									<div class="articles-left">
										<a href="blog-details.html">
											<div class="articles-img">
												<img src="assets/img/blog/blog-24.jpg" class="img-fluid" alt="Darren Elder">
											</div>
										</a>
									</div>
									<div class="articles-right">
							...
							<div class="articles-grid w-100">
								<div class="articles-info">
									<div class="articles-left">
										<a href="blog-details.html">
											<div class="articles-img">
												<img src="assets/img/blog/blog-25.jpg" class="img-fluid" alt="Ruby Perrin">
											</div>
										</a>
									</div>
									<div class="articles-right">
										<div class="articles-content">
											...
											<h4>
												<a href="">Sleep Solutions: Unveiling the Secrets to a Restful Night</a>
											</h4>
							...
							<div class="articles-grid w-100">
								<div class="articles-info">
									<div class="articles-left">
										<a href="blog-details.html">
											<div class="articles-img">
												<img src="assets/img/blog/blog-12.jpg" class="img-fluid" alt="Sofia Brient">
											</div>
										</a>
									</div>
									<div class="articles-right">
										<div class="articles-content">
											...
											<h4>
												<a href="">Mental Wellness in a Digital Age: Strategies for a Healthy Mind Online</a>
											</h4>
							...
							<div class="col-lg-6 col-md-12">
								<div class="app-content">
									...
									<div class="google-imgs aos" data-aos="fade-up">
										<a href="javascript:void(0);"><img src="assets/img/icons/google-play-icon.svg" alt="img"></a>
										<a href="javascript:void(0);"><img src="assets/img/icons/app-store-icon.svg" alt="img"></a>
									</div>
								</div>
							</div>
		...
		<!-- jQuery -->
	<script src="assets/js/jquery-3.7.1.min.js" type="5325059b13f1f6b5faaa69bf-text/javascript"></script>
		
		<!-- Bootstrap Bundle JS -->
		<script src="assets/js/bootstrap.bundle.min.js" type="5325059b13f1f6b5faaa69bf-text/javascript"></script>
		
		<!-- Feather Icon JS -->
		<script src="assets/js/feather.min.js" type="5325059b13f1f6b5faaa69bf-text/javascript"></script>

		<!-- Datepicker JS -->
		<script src="assets/js/moment.min.js" type="5325059b13f1f6b5faaa69bf-text/javascript"></script>
		<script src="assets/js/bootstrap-datetimepicker.min.js" type="5325059b13f1f6b5faaa69bf-text/javascript"></script>

		<!-- Owl Carousel JS -->
		<script src="assets/js/owl.carousel.min.js" type="5325059b13f1f6b5faaa69bf-text/javascript"></script>

		<!-- Slick JS -->
		<script src="assets/js/slick.js" type="5325059b13f1f6b5faaa69bf-text/javascript"></script>

		<!-- Animation JS -->
		<script src="assets/js/aos.js" type="5325059b13f1f6b5faaa69bf-text/javascript"></script>

		<!-- Counter JS -->
		<script src="assets/js/counter.js" type="5325059b13f1f6b5faaa69bf-text/javascript"></script>

		<!-- BacktoTop JS -->
		<script src="assets/js/backToTop.js" type="5325059b13f1f6b5faaa69bf-text/javascript"></script>

		<!-- Custom JS -->
		<script src="assets/js/script.js" type="5325059b13f1f6b5faaa69bf-text/javascript"></script>
	
	<script src="assets/js/rocket-loader.min.js" data-cf-settings="5325059b13f1f6b5faaa69bf-|49" defer></script></body>
