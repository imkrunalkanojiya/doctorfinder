        ...
        <nav class="navbar navbar-expand-lg header-nav">
            <div class="navbar-header">
                ...
                <a href="/" class="navbar-brand logo">
                    <!-- <img src="assets/img/logo-01.svg" class="img-fluid" alt="Logo"> -->
                     <h3 class="section-title">DoctorFinder</h3>
                </a>
            </div>
            ...
            <ul class="nav header-navbar-rht">
                <li class="register-btn">
                    <a href="register.jsp" class="btn reg-btn"><i class="feather-user"></i>Register</a>
                </li>
                <li class="register-btn">
                    <a href="login.jsp" class="btn btn-primary log-btn"><i class="feather-lock"></i>Login</a>
                </li>
            </ul>
        </nav>
    </div>
